...
class InitSdxlCompelTests(unittest.TestCase):
    def setUp(self):
        self.original_compel = compel_support.CompelForSDXL
        self.addCleanup(setattr, compel_support, "CompelForSDXL", self.original_compel)

    def test_init_sdxl_compel_returns_none_when_compel_is_unavailable(self):
        compel_support.CompelForSDXL = None
    ...
    def test_init_sdxl_compel_builds_compel_with_pipe_and_device(self):
        pipe = object()
        compel_support.CompelForSDXL = _FakeCompelForSDXL
